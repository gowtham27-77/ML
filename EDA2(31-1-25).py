...
# Read all nimeric (continous) columns into a new table data1_numeric
...
####Obervations 
# THE highest correlation strength is oberved between Ozone and temperature (0.597087)
# The next highest correlation strength is oberved between Ozone and  wind (-0.526616)
